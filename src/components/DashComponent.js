        ...
        <div className="middle-sidebar-left">
          <div className="row">
            ...
            <div className="col-md-4 pe-md-2 ps-md-2">
              ...
              >
                <div className="card-body d-flex p-0">
                  <i className="btn-round-lg d-inline-block me-4 bg-secondary feather-heart font-md text-white"></i>
            ...
            <div class="col-md-4 ps-md-2">
              <div class="card dash-card shadow-none bg-grey p-4 mb-3">
                <div class="card-body d-flex p-0">
                  <i class="icon-round-lg me-3 bg-greydark feather-file"></i>
          ...
          {props.supportersNum === 0 ? (
            <div className="row">
              <div className="col-lg-12">
                <div className="card w-100 border-0 shadow-1 p-4_5 rounded-xxl mb-3">
                  <h4 className="fw-700 mb-3 font-xsss text-grey-600">
                    RECENT SUPPORTERS
                  </h4>
                  <i className="feather-heart btn-round-lg bg-grey font-md fw-700 text-grey-500 d-inline-block mx-auto mb-3"></i>
                  <h2 className="fw-700 font-xs text-center mb-3">
                    You don't have any supporters yet
                  </h2>
                  <p className="text-grey-600 text-center mw-600 mx-auto">
                  ...
                  <div className="form-group form-group-icon choose-link-input mw-400 mx-auto">
                    ...
                    <span className="choose-link-input-text">
                      trendupp.com/
                    </span>
                    <input
                      type="text"
                      className="form-control style2-input mb-0"
                    ...
                    >
                      <span className="input-icon-e copy-button">
                        {" "}
                        Tap to Copy
                      </span>
                    </CopyToClipboard>
                ...
                <div class="card dash-card dash-card__records dash-card__supporters">
                  <div class="row">
                    ...
                    <div class="col-6 col-sm-4 text-right mobile-support">
                      <Link
                        class="btn-card-title btn btn-grey mt--10 font-xssss "
                        to="/supporters"
                      >
                        View all Supporters
                      </Link>
                  ...
                  {props.supporters.map((item) => {
                    return (
                      <div class="single-record-row d-flex">
                        ...
                        <div
                          class="dropdown-menu dropdown-menu-end p-4 rounded-xxl border-0 shadow-md mobile-drop"
            ...
            <div class="col-12">
              <div class="card dash-card">
                ...
                <div class="tip-single">
                  <div class="tip-icon">
                    <i class="font-xxl text-grey-400 me-3 feather-heart"></i>
                  </div>
                  <div class="tip-details">
                    <h5 class="font-xs fw-700">Tip 1</h5>
                    <p>
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Consequatur autem eaque
                    </p>
                  </div>
                </div>
                <div class="tip-single border-0 pb-0 mb-0">
                  <div class="tip-icon">
                    <i class="font-xxl text-grey-400 me-3 feather-zap"></i>
                  </div>
                  <div class="tip-details">
