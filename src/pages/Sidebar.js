        ...
        <div>
            <div className="nav-wrap">
                <ul className="mb-1">
                    ...
                    <li  ><Link to="/supporters" className="nav-content-bttn h-auto pt-2 pb-2"><i
                                className="feather-heart"></i><span>Supporters</span></Link></li>
                     <li ><Link to="/wallet" class="nav-content-bttn h-auto pt-2 pb-2"><i
                                    class="feather-shopping-bag"></i><span>Wallet</span></Link></li>
                    <li ><Link to="/settings" class="nav-content-bttn h-auto pt-2 pb-2"><i
