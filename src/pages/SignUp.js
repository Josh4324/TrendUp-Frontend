        ...
        <div className="row">
          <div className="col-xl-4 mx-auto">
            <div className="login-card mx-auto">
              <h2 className="login-card-title" style={{ fontSize: "28px" }}>
                Create an account
              </h2>
              ...
              <form action="user_onboard1.html" method="GET">
                ...
                <div className="col-sm-12 p-0">
                  ...
                  <p className="form-desc mt-3">
                    By signing up, you agree to our terms and privacy policy. We
                    do not allow inappropriate content. You must be 18 years old
                    to have an account
                  </p>
                </div>
              </form>
