      ...
      <div className="main-wrapper">
        ...
        >
          {view === "post" ? (
            ...
            <EditPost public1={public1} support={support} postData={postData} />
          ) : (
            <PostView
              setModal={setModal}
              setView={setView}
        ...
        <div class="popup-wrapper pt-0" id="popupWrapper">
          ...
          <div class="popup-body card mw-400 mx-auto bg-white p-5 rounded-xxl">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-12 mb-3" onClick={() => deletePost(postId)}>
                  <span class="btn d-block w-100">Confirm</span>
                </div>
                <div class="col-12">
                  <span
                    onClick={() => setModal(false)}
                    class="btn btn-grey d-block w-100"
                  >
                    Cancel
                  </span>
                </div>
