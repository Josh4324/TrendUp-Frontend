...
function Onboard2(props) {
  ...
  const submit = async (evt) => {
    ...
    const result = await onboard2Call(
      cred,
      setLoader,
      setError,
      history,
      ...
      <div class="row">
        <div class="col-lg-6 col-md-8 mx-auto">
          <div class="user-onboard userdetails-onboard">
            ...
            <h4 class="useronboard-subtitle mb-5">
              Please fill in basic information about yourself and the creative
              work
            </h4>
            <form
              onSubmit={submit}
                ...
                <div class="col-lg-12 mb-2">
                  <div class="form-group">
                    <input
                      ...
                      pattern="[A-Za-z0-9 ]+"
                      title="Only Alphanumeric Characters and space are allowed"
                      ref={brandRef}
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <p class="text-grey-600 font-xssss mb-2">
                    Enter the username of the social media platforms you are on
                  </p>
                </div>
                ...
                <div class="col-12 mb-2">
                  <div class="form-group form-group-icon social-platform-input">
                    <span class="input-icon">
                      <img src="images/Instagram_AppIcon_Aug2017.png" alt="" />
                    </span>
                    <input
                      type="text"
                      class="form-control style2-input"
